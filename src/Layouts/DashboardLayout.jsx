    ...
    <div className="flex h-screen primary-bg">
      ...
      > 
        ...
        <ul className="menu w-full mt-2 flex-1 p-2 gap-2">
          ...
          {/* Post Food */}
          <li>
            <NavLink className="flex items-center gap-2" to="/add-food">
          ...
          <li>
            <NavLink className="flex items-center gap-2" to="/req-food">
          ...
          <li>
            <NavLink className="flex items-center gap-2" to="/settings">
...
<div className="flex gap-1 items-center hidden sm:flex">
  ...
  <p className="font-semibold text-blue-600">{user.displayName || "User"}</p>
</div>
          {/* Right buttons */}
            ...
            {user ? (
              <div className="dropdown dropdown-end">
                ...
                >
                  ...
                  <li>
                    <NavLink to="/req-food">My Food Requests</NavLink>
                  </li>
                  <div className="divider my-0"></div>
                  <li>
                    <button
